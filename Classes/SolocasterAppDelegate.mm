...
@implementation SolocasterAppDelegate
...
@synthesize trackNumberArray;
@synthesize instrumentArray;
@synthesize drumKitArray;

@synthesize tempo;
@synthesize loopLength;
@synthesize recordingTrackNumber;
@synthesize isRecordBeat;
@synthesize isRecordInstrument;

@synthesize volumeElapsedMin;
@synthesize volumeElapsedSec;
@synthesize pitchElapsedMin;
@synthesize pitchElapsedSec;
@synthesize recordingElapsedMin;
@synthesize recordingElapsedSec;
@synthesize newBeatElapsedMin;
@synthesize newBeatElapsedSec;
